...
function gameOver(a) {
    var gameOverAlertElement = "<b>GAME OVER </b><br><br> Joueur " + span[a].dataset.player.toUpperCase() + ' GAGNE !!! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>EGALITE!!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
